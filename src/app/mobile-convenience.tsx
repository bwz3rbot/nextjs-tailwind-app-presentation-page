		...
		<section className="py-20 px-8">
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
				...
				<div className="col-span-1 mx-auto max-w-lg px-4 lg:px-0">
					...
					>
						Join our vibrant online community of fitness enthusiasts
						who are on the same journey as you. Share your progress,
						celebrate your achievements, and find motivation and
						support from fellow members and our team of coaches.
						Together, we'll inspire and empower each other to reach
						new heights.
					</Typography>
