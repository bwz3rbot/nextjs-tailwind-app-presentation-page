	...
	return (
		<section className="py-28 px-4">
			<div className="container mx-auto mb-20 text-center">
				...
				>
					With FitPro Connect, you have the flexibility to work out
					anytime, anywhere. Our online platform allows you to access
					your workouts and connect with your coach from the comfort
					of your home, the gym, or even while traveling. Say goodbye
					to restrictive gym schedules and hello to workouts that fit
